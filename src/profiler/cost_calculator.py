...
class CostCalculator:
    ...
    def _get_amazon_pricing_units(self,
        ...
        try:
            ...
            raise CostCalculationError(f"Error has been raised while fetching the pricing information: {e}")
        
        else:
            price_groups = ["AWS-Lambda-Duration-ARM", "AWS-Lambda-Requests-ARM"] if architecture == 'arm64' else ["AWS-Lambda-Duration", "AWS-Lambda-Requests"]
